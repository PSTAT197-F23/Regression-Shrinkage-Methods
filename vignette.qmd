---
title: "Vignette - Regression Shrinkage Methods"
author: "Ryan Yee & Aaron Lee"
date: "2023-12-06"
output:
    html_document:
      toc: true
...
![Image of Ridge regression and Lasso regression](img\ridge_lasso_regression.png)
...
These final models can now be applied on our testing data sets to assess their abilities to generalize to brand new data:
